...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(afterSignUp)/FillNameScreen` | `/FillNameScreen` | `/(afterSignUp)/PickImageScreen` | `/PickImageScreen` | `/(afterSignUp)/_layout` | `/_layout` | `/(auth)/SignInScreen` | `/SignInScreen` | `/(auth)/_layout` | `/(root)/WalletScreen` | `/WalletScreen` | `/(root)/_layout` | `/(root)/feed/FeedScreen` | `/feed/FeedScreen` | `/(root)/feed/_layout` | `/feed/_layout` | `/(root)/feed/` | `/feed/` | `/(root)/feed` | `/(root)/` | `/(root)` | `/(root)/shop/CartItemOptions` | `/shop/CartItemOptions` | `/(root)/shop/_layout` | `/shop/_layout` | `/(root)/shop/cart/` | `/shop/cart/` | `/(root)/shop/cart` | `/(root)/shop/party/IntroScreen` | `/shop/party/IntroScreen` | `/(root)/shop/party/PartyCodeScreen` | `/shop/party/PartyCodeScreen` | `/+html` | `/.expo/README.md` | `/.expo/settings.json` | `/modal`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/(root)/shop/${SingleRoutePart<T>}` | `/shop/${SingleRoutePart<T>}` | `/${CatchAllRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/(root)/shop/[id]` | `/[...missing]`;
